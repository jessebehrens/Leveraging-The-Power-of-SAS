...
DO i=1 to 500;
  ...
  name_match=rand('normal');
  IF rand('uniform') <0.05 then name_match=.;  /*Create missing*/
...
/*Simulate a generic right table - we will need to rename name_match down the line.  We will do it later
